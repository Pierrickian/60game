  ...
  function guess(predictedCard, buttonIndex) {
    ...
    setTables((currentTables) => {
      ...
      if (isWin) {
        ...
        if (jokerTriggered) showGameplayLog('other', 'JOKER  x1')
