        ...
        if (jokerTriggered) {
          ...
          if (selectedPower) {
            ...
            if (handler) {
              ...
              const popupId = `${selectedPower.id}-${Date.now()}`
